...
public class Chrono {
    ...
    static final int MAX_DATO = 1000;
    static final int MAX_CASOS = 200000;
    ...
    public static void main (String[] args) {
        ...
        String csvFile = "C://Users//alvar//xXx//ML//repoJava//N//ninosPrimero//tiempos.csv";
        try (BufferedWriter csvWriter = new BufferedWriter(new FileWriter(csvFile, false))) {
            ...
            for (int i = 0; i < OBSERVATIONS; i++) {
                String casosFile = "C://Users//alvar//xXx//ML//repoJava//N//ninosPrimero//casos.txt";
                ...
                long end = start;
                Process process = Runtime.getRuntime().exec("java NinosPrimero");
